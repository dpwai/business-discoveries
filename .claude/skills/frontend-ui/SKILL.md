...
Ask clarifying questions about purpose, target audience, desired mood/feeling, specific aesthetic preferences.
...
| Set | Aesthetic | Fonts |
|-----|-----------|-------|
| 1 | Terminal | JetBrains Mono + IBM Plex Mono |
| 2 | Modern Editorial | Playfair Display + Space Grotesk |
| 3 | Geometric Bold | Clash Display + Manrope |
| 4 | Retro Future | Space Mono + Outfit |
| 5 | Elegant Tech | Crimson Pro + Fira Code |
| 6 | Neo Brutalist | Syne + General Sans |
