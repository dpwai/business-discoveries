...
### 4.1 Dados já recuperados e processados ✅

> Todos os ETLs foram re-executados com sucesso em 02/03/2026.

| Dado | Registros | Status |
|------|-----------|--------|
| Parceiros/Fornecedores AgriWin | 2.201 | ✅ ETL re-rodado |
| Insumos catálogo AgriWin | 18.499 | ✅ ETL re-rodado (201 xlsx) |
| Castrolanda Extrato (9 contas, fev/2020→fev/2026) | 8.211 | ✅ ETL re-rodado |
| Castrolanda CC mensal (jan/2025→fev/2026) | 580 | ✅ ETL re-rodado (14 meses) |
| Castrolanda Capital HTML | 77 | ✅ processado antes |
| Castrolanda Financiamentos | 220 | ✅ processado antes |
| Castrolanda Vendas | 170 | ✅ processado antes |
| Castrolanda Carga-a-Carga | 1.337 | ✅ processado antes |
| UBG Caixa Histórico | 19.325 | ✅ ETL re-rodado (201 abas, 2011→2026) |
| UBG Produção (Tickets Pesagem) | 883 | ✅ ETL re-rodado (18 xlsx, 4 safras) |
| Maquinário Histórico | 32.516 | ✅ processado antes |
| Tags Vestro | 42 tags + 30 operadores | ✅ processado antes |

### 4.2 Dados ainda pendentes

| Dado | Problema | Quem resolve |
|------|----------|-------------|
| **Soja 25/26** | Arquivo no zip é cópia do 24/25. Falta o arquivo real | Josmar/Vanessa |
| **Milho 25/26** | Apenas 2 de 10 talhões são novos (resto é cópia do 24/25) | Josmar/Vanessa |
| **Ticket Balança Milho 24/25** | Arquivo entregue é duplicate do 23/24 (mislabeled) | Josmar/Vanessa |
| **Carga-a-Carga Soja Intacta 22/23** | Erro 500 no download do portal. Re-baixar | Rodrigo |
| Abastecimentos Vestro (preço por litro) | Portal exporta com PPU=1 (sem preço real) | João auditar |

**Pergunta para Claudio:** Josmar/Vanessa têm os arquivos corretos de Soja 25/26, Milho 25/26, e Milho 24/25? Precisamos dos xlsx reais, não cópias.
...
### Claudio (hoje):
- [x] ~~CNPJ~~ → ✅ Encontrado online: **31.561.869/0001-39** (Piraí do Sul/PR)
- [ ] **Confirmar município:** Registro diz Piraí do Sul — correto ou é Castro?
...
- [ ] Confirmar quem tem login no portal Castrolanda
- [ ] Confirmar se AgriWin ainda acessível
...
- [x] ~~Re-exportar Parceiros do AgriWin~~ → ✅ 2.201 registros recuperados
- [x] ~~Re-exportar Insumos do AgriWin~~ → ✅ 18.499 registros recuperados
- [ ] Informar regime tributário da SOAL
- [ ] Contatos (sobrenome, email, telefone) dela mesma
- [ ] Lista de trabalhadores rurais (nome, cargo, setor, tipo contrato)
- [ ] Contratos ativos (arrendamento, prestação de serviço)

### Josmar (esta semana):
- [ ] Lista completa de silos (nome, capacidade, material, aeração, termometria)
- [ ] Dados UBG (capacidade recepção/secagem, software, RT)
- [ ] **Arquivo CORRETO de Soja 25/26** (o que veio é cópia do 24/25)
- [ ] **Arquivo CORRETO de Milho 25/26** (só 2 talhões novos, resto é cópia)
- [ ] **Arquivo CORRETO de Milho 24/25** (veio mislabeled como 23/24)
...
**Total registros prontos: ~1.460+** (580 imports + 883 produção UBG)
**Total registros pendente re-processamento: ~86.000** (ETLs prontos, falta xlsx fonte)

---

## PARTE 8 — Demonstração: CSV Unificado de Produção UBG (NOVO)

> ETL criado hoje. Processou 18 arquivos Excel (5 zips), 7 culturas, 4 safras.

### Resultado

| Métrica | Valor |
|---------|-------|
| **Total tickets de pesagem** | **883** |
| **Safras** | 22/23, 23/24, 24/25, 25/26 |
| **Culturas** | Soja, Milho, Feijão, Trigo, Azevem, Aveia Branca, Aveia Preta |
| **Talhões únicos** | 65 |
| **Motoristas** | 17 |
| **Período** | Dez/2022 → Fev/2026 |
| **Peso líquido total** | **20.669 toneladas** |

### Volume por safra + cultura (toneladas)

| Safra | Cultura | Tickets | Talhões | Peso (ton) |
|-------|---------|---------|---------|-----------|
| 22/23 | Azevem | 4 | 3 | 27 |
| 23/24 | Azevem | 8 | 2 | 40 |
| 23/24 | Milho | 164 | 10 | 4.219 |
| 23/24 | Trigo | 57 | 1 | 1.625 |
| 24/25 | Aveia Preta | 2 | 2 | 15 |
| 24/25 | Azevem | 8 | 3 | 58 |
| 24/25 | Feijão | 28 | 3 | 909 |
| 24/25 | **Soja** | **371** | **41** | **7.924** |
| 24/25 | Trigo | 45 | 5 | 1.324 |
| 25/26 | Aveia Branca | 14 | 2 | 197 |
| 25/26 | Aveia Preta | 25 | 3 | 274 |
| 25/26 | Azevem | 23 | 4 | 183 |
| 25/26 | Feijão | 26 | 7 | 571 |
| 25/26 | Milho | 35 | 2 | 997 |
| 25/26 | Trigo | 73 | 1 | 2.306 |
| **TOTAL** | | **883** | **65** | **20.669** |

### Colunas do CSV

```
safra, cultura, arquivo_fonte, aba, talhao_header, area_ha, produtividade_kg_ha,
produto_variedade, producao_total_kg, data, hora, gleba, destino, variedade_ticket,
motorista, placa, peso_bruto, peso_tara, peso_liquido, umidade_pct, ph,
impureza_pct, ardidos_pct, avariado_pct, verdes_pct, quebrado_pct, desconto_kg, peso_final
```

### Observações para Claudio

1. **Dados 25/26 incompletos**: Soja 25/26 ainda não tem arquivo (o arquivo na pasta 25-26 é cópia do 24-25)
2. **Milho 25/26 parcial**: Apenas SANTA RITA e SANTO ANDRE (35 tickets). Demais abas são cópia do 23/24.
3. **Erros de digitação pontuais**: Algumas linhas têm motorista/placa invertidos — corrigível na validação
4. **PH não preenchido**: Coluna PH está vazia em 100% dos dados — Josmar não registra?
5. **Azevem "2020"**: Arquivo contém dados de safras 22/23 e 23/24 (nome enganoso)
6. **Trigo 22/23**: Apenas 1 aba (LAJEADO) com 57 tickets — confirmar se é tudo

### Perguntas para Claudio

1. **SOJA 25/26 — quando chega o arquivo?** O que está no zip 25-26 é cópia do 24-25.
2. **PH (peso hectolítrico) — é registrado?** A coluna existe mas está vazia em todos os arquivos.
3. **Ticket 200g template** — qual a utilidade desse arquivo? Podemos ignorar?
4. **Viagens Freteiros** — esses dados vão para qual entidade? FRETE? Ou fica fora do V0?
